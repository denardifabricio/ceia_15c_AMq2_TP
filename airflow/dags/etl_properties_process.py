import sys
import os
#sys.path.append(os.path.abspath('../../properities'))
...
markdown_text = """
### ETL Process for Properties from CABA
...
@dag(
    dag_id="process_etl_properties",
    description="ETL process for properties, separating the dataset into training and testing sets.",
    doc_md=markdown_text,
    tags=["ETL", "Properties"],
    default_args=default_args,
    catchup=False,
)
def process_etl_properties_data():
...
dag =  process_etl_properties_data()